...
# qfrag executable
QFRAG_JAR_DIR="/home/ehussein/ArabesqueWorkspace/QFragSpark/target"
QFRAG_JAR=`find $QFRAG_JAR_DIR -maxdepth 1 -name "QFragSpark-*-jar-with-dependencies.jar" | head -1`
...
$SPARK_HOME/bin/spark-submit --driver-memory $driverMemory --conf spark.driver.maxResultSize=$maxResultSize --verbose --class  Runner $QFRAG_JAR -y $(basename $tempfile)
