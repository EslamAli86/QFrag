...
/*                    .put("worker_context", new GiraphClassConfigurationAssignment<WorkerContext>() {
                    ...
                    .put("communication_strategy", new GiraphConfigurationAssignment() {
                        ...
                        public void assign(String propertyKey, Object propertyValue, GiraphConfiguration giraphConfiguration) {
                            ...
                            giraphConfiguration.set(conf.Configuration.CONF_COMM_STRATEGY_FACTORY_CLASS, strategyFactoryClass);
                        }
                    })
                    ...
                    // Output
                    .put("output_active", new GiraphBooleanConfigurationAssignment(conf.Configuration.CONF_OUTPUT_ACTIVE))
                    .put("output_path", new GiraphStringConfigurationAssignment(conf.Configuration.CONF_OUTPUT_PATH))
